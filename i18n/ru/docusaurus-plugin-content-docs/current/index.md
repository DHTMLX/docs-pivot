...
slug: /
description: Ознакомьтесь с обзором библиотеки DHTMLX JavaScript Pivot в документации. Изучите руководства разработчика и справочник API, опробуйте примеры кода и живые демо, а также загрузите бесплатную 30-дневную ознакомительную версию DHTMLX Pivot.
---
...
![Интерфейс DHTMLX Pivot: панель настройки и таблица с данными](assets/pivot-main.png)
...
![Панель настройки DHTMLX Pivot с областями значений, столбцов и строк](assets/config_panel.png)
...
![Добавление и удаление полей в панели настройки DHTMLX Pivot](assets/add_remove.png)
...
![Изменение порядка и приоритета полей в области DHTMLX Pivot](assets/priority.png)
...
![Выбор операции агрегации данных для поля значения в DHTMLX Pivot](assets/operations.png)
...
![Фильтрация данных поля в DHTMLX Pivot](assets/filter.png)
...
![Сортировка данных по заголовку столбца в таблице DHTMLX Pivot](assets/table.png)
