...
![Панель настройки DHTMLX Pivot с областями значений, столбцов и строк](/img/config_panel.png)
...
![Добавление и удаление полей в панели настройки DHTMLX Pivot](/img/add_remove.png)
...
![Изменение порядка и приоритета полей в области DHTMLX Pivot](/img/priority.png)
...
![Выбор операции агрегации данных для поля значения в DHTMLX Pivot](/img/operations.png)
...
![Фильтрация данных поля в DHTMLX Pivot](/img/filter.png)
...
![Сортировка данных по заголовку столбца в таблице DHTMLX Pivot](/img/table.png)
