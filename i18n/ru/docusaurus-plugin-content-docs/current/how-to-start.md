...
- [MCP-сервер DHTMLX](guides/mcp-server.md) подключает ИИ-ассистента для написания кода к этой документации, чтобы он мог обращаться к актуальному API Pivot во время разработки
