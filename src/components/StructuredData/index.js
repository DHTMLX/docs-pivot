...
const SITE_NAME = 'DHTMLX Pivot Docs';
const PRODUCT_NAME = 'DHTMLX Pivot';
const PRODUCT_URL = 'https://dhtmlx.com/docs/products/dhtmlxPivot/';

function resolveType(pathname) {
    const path = (pathname || '').replace(/\/+$/, '');
    if (path === '' || path === '/pivot') return 'SoftwareApplication';
